library(lubridate)
po <- read.table('C:/BAK/Data Analytics/Data Sets/household_power_consumption.txt', header = TRUE, 
...
with(po,plot(datetime,Global_active_power,type="l",ylab="Global Active Power",xlab=NA))

with(po,plot(datetime,Voltage,type="l",ylab="Voltage"))
...
with(po,plot(datetime,Global_reactive_power,type="l",ylab="Global Active Power"))
